package com.example.talathiapp.numberconvertercore;
...
public class ConvertIND {
    ...
    public ConvertIND(Context context) {
        this.context = context;
    }

    /**
     * interface for sending the conversionResult to the calling function after the execution is
     * finished.
     */
    public interface CallbackConvertIND {
        void conversionResultIND(ConversionResult conversionResult);
    }
        ...
        switch (numberToConvert) {
            ...
            default:
                ...
                if (tenthDigitWordResult.getResultCode() == ConversionResult.ResultCode.FAIL) {
                    return new ConversionResult(ErrorMaster.NOT_A_NUMBER + digits[0],
                            ConversionResult.ResultCode.FAIL);
                }
                ...
                if (unitDigitWordResult.getResultCode() == ConversionResult.ResultCode.FAIL) {
                    return new ConversionResult(ErrorMaster.NOT_A_NUMBER + digits[1],
                            ConversionResult.ResultCode.FAIL);
                }
                return new ConversionResult(tenthDigitWordResult.getResult().get(0) +
    ...
    private ConversionResult convertThreeDigitToWord(String numberToConvert) {
        try {
            ...
            ConversionResult conversionResultHundredPlace =
                    convertSingleDigitToWords(String.valueOf(digits[0]));
            ...
            if (conversionResultHundredPlace.getResult().get(0).equals(Numbers.ZERO)) {
                result.setResult((conversionResultTenthPlace.getResult().get(0)
                        .equals(Numbers.NOTHING) ?
                        "" : DividersIND.SPACE) + conversionResultTenthPlace.getResult().get(0));
            } else {
                result.setResult(conversionResultHundredPlace.getResult().get(0) +
                        DividersIND.SPACE + DividersIND.HUNDRED +
            ...
            return new ConversionResult(ErrorMaster.FAILED_DURING_CONVERTING +
                    numberToConvert, ConversionResult.ResultCode.FAIL);
        }
    }
    ...
    private ConversionResult proceedByDividingNumber(String numberToConvert) {
        ...
        result.setResultCode(ConversionResult.ResultCode.SUCCESS);
        if (commasDividedStringArray.length > DividersIND.MAX_DIVIDER_LIMIT) {
            String temp = "";
            String commasDividedStringTemp = "";
            int i;
            for (i = 0; i <= commasDividedStringArray.length - DividersIND.MAX_DIVIDER_LIMIT; i++) {
            ...
            conversionResultTemp = temp.length() == 1 ? convertSingleDigitToWords(temp) :
                    temp.length() == 2 ? convertDoubleDigitToWords(temp) : temp.length() == 3 ?
        ...
        if (commasDividedStringArray.length == 2) {
                ...
                if (conversionResultTemp.getResult().size() == 0) {
                    result.setResult(
                            convertSingleDigitToWords(
                                    ...
                                    DividersIND.SPACE + DividersIND.getDividerNameByPos(1) +
                                    DividersIND.SPACE +
                                    convertThreeDigitToWord(
                                            commasDividedStringArray[1]).getResult().get(0));
                } else {
                    for (int i = 0; i < conversionResultTemp.getResult().size(); i++) {
                        result.setResult(
                                conversionResultTemp.getResult().get(i) + DividersIND.SPACE +
                                        DividersIND.MAHA_SANKH + DividersIND.SPACE +
                                        convertSingleDigitToWords(
                                                commasDividedStringArray[0]).getResult().get(0) +
                                        DividersIND.SPACE + DividersIND.getDividerNameByPos(1) +
                                        DividersIND.SPACE +
            ...
            if (commasDividedStringArray[0].length() == 2) {
                if (conversionResultTemp.getResult().size() == 0) {
                    result.setResult(convertDoubleDigitToWords(
                            commasDividedStringArray[0]).getResult().get(0) + DividersIND.SPACE +
                            DividersIND.getDividerNameByPos(1) + DividersIND.SPACE +
                ...
                if (conversionResultTemp.getResult().size() == 0) {
                    ...
                    for (int i = 0; i < conversionResultTemp.getResult().size(); i++) {
                        result.setResult(conversionResultTemp.getResult().get(i) +
                                DividersIND.SPACE + DividersIND.MAHA_SANKH + DividersIND.SPACE +
                                convertThreeDigitToWord(
                                        commasDividedStringArray[0]).getResult().get(0) +
                                DividersIND.SPACE + DividersIND.getDividerNameByPos(1) +
                                DividersIND.SPACE +
            ...
            for (int i = 0; i <= commasDividedStringArray.length - 2; i++) {
                ...
                for (int j = i + 1; j < commasDividedStringArray.length; j++) {
                    if (commasDividedStringArray[j].length() == 1) {
                        strRightSide = strRightSide +
                                (convertSingleDigitToWords(
                                        commasDividedStringArray[j]).getResult().get(0)
                                        .equals(Numbers.ZERO) ? "" :
                                        convertSingleDigitToWords(
                                                commasDividedStringArray[j]).getResult().get(0) +
                                                DividersIND.SPACE +
                                                DividersIND.getDividerNameByPos(
                                                        commasDividedStringArray.length - 1 - j) +
                                                DividersIND.SPACE);
                    ...
                    for (int j = 0; j < conversionResult.getResult().size(); j++) {
                        if (conversionResultTemp.getResult().size() == 0) {
                            if (conversionResult.getResult().get(j).equals(Numbers.ZERO)) {
                                ...
                                result.setResult(conversionResult.getResult().get(j) +
                                        DividersIND.SPACE +
                                        DividersIND.getDividerNameByPos(
                                                commasDividedStringArray.length - 1 - i) +
                                        DividersIND.SPACE + strRightSide);
                            }
                        } else {
                            for (int k = 0; k < conversionResultTemp.getResult().size(); k++) {
                                result.setResult(
                                        conversionResultTemp.getResult().get(k) +
                                                DividersIND.SPACE + DividersIND.MAHA_SANKH +
                                                DividersIND.SPACE +
                    ...
                    if (strLeftSide.length() == 1) {
                        if (conversionResultTemp.getResult().size() == 0) {
                            ...
                            for (int k = 0; k < conversionResultTemp.getResult().size(); k++) {
                                if (convertSingleDigitToWords(strLeftSide).getResult().get(0).equals(Numbers.ZERO)) {
                                    result.setResult(conversionResultTemp.getResult().get(i) +
                                            DividersIND.SPACE + DividersIND.MAHA_SANKH + strRightSide);
                                } else {
                                    result
                                            .setResult(
                                                    conversionResultTemp.getResult().get(i) +
                                                            DividersIND.SPACE +
                                                            DividersIND.MAHA_SANKH +
                                                            DividersIND.SPACE +
                                                            convertSingleDigitToWords(strLeftSide).getResult().get(0) +
                                                            DividersIND.SPACE +
                                                            DividersIND
                                ...
                                if (convertThreeDigitToWord(strLeftSide).getResult().get(0).equals(Numbers.NOTHING)) {
                                    ...
                                    result.setResult(
                                            conversionResultTemp.getResult().get(i) +
                                                    ...
                                                    convertThreeDigitToWord(strLeftSide).getResult().get(0) +
                                                    DividersIND.SPACE +
                                                    DividersIND.getDividerNameByPos(commasDividedStringArray.length - 1 - i) +
                                                    DividersIND.SPACE + strRightSide);
                                }
                            }
                        }
     ...
     * placing comma at every 3rd place from the last.
    ...
    private String divideNumberWithCommas(String numberToConvert) {
        ...
        digitsArraylist.add(digitsArraylist.size() - 3, DividersIND.COMMA);
    ...
    /**
     * method to place comma at every 3rd place of the number.
    ...
    private ArrayList<String> addDividerEverySecondPlace(ArrayList<String> digitsArrayList) {
        ...
        for (int i = 0; i < digitsArrayList.size(); i++) {
            if (digitsArrayList.get(i).equals(DividersIND.COMMA)) {
                leftMostComaPos = i;
                break;
            }
        }
        if (leftMostComaPos <= 2)
            return digitsArrayList;
        digitsArrayList.add(leftMostComaPos - 2, DividersIND.COMMA);
    ...
    private void sendResult(ConversionResult conversionResult) {
        ((CallbackConvertIND) context).conversionResultIND(conversionResult);
    }
}
